...
- Oportunamente (Nome do plugin)
- op (nome dos arquivos, nome do text domain e slug da url do repositório)
- OP_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- op_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Oportunamente, através do próprio sistema de atualizações do WordPress
